...
| Example | Focus |
|---------|-------|
| `examples/showcase/retrieval/retrieval_and_similarity/` | Spreading activation, embedding similarity, RRF retrieval |
| `examples/showcase/retrieval/retrieval_and_feedback/` | Security knowledge retrieval with learning-to-rank |
| `examples/showcase/core/centrality_and_ranking/` | Degree, betweenness, PageRank comparison |
