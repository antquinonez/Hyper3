...
```bash
.venv/bin/python examples/showcase/topic_exploration/topic_exploration.py
```
...
| Example | Focus |
|---------|-------|
| `examples/showcase/code_dependency_analysis/` | Dependency blast radius with centrality, cycles, subgraph collapse |
| `examples/showcase/microservices_reasoning/` | Microservice blast radius with TransitiveRule and InverseRule |
| `examples/showcase/centrality_and_ranking/` | Degree, betweenness, PageRank, and eigenvector centrality |
