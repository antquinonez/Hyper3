...
```bash
.venv/bin/python examples/showcase/paths_and_connectivity/shortest_paths_and_traversal.py
```
...
```bash
.venv/bin/python examples/showcase/paths_and_connectivity/connectivity_and_distances.py
```
...
```bash
.venv/bin/python examples/showcase/paths_and_connectivity/advanced_paths.py
```
