...
```bash
.venv/bin/python examples/showcase/temporal_incident_forensics/temporal_incident_forensics.py
```
...
| Example | Topic |
|---------|-------|
| `examples/showcase/infrastructure_self_healing/` | Feedback-driven infrastructure evolution |
| `examples/showcase/quantum_diagnostics/` | Hypothesis management during incidents |
