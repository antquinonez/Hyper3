...
| Example | Focus |
|---------|-------|
| `examples/showcase/core/statistics_and_metrics/` | Degree, centrality, and weighted metrics |
| `examples/showcase/core/structural_patterns/` | Community detection and graph structure |
| `examples/showcase/reasoning/multiway_reasoning/` | Rule-based inference on temporal chains |
