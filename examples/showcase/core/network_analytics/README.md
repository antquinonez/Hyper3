...
|--------|-------|---------|
| Modularity | 0-1 | Higher = clearer community separation; 0.3-0.7 indicates moderate-to-strong structure |
| Coverage | 0-1 | Fraction of edges within communities; 0.78 means most edges stay within clusters |
...
| Example | Focus |
|---------|-------|
| `examples/showcase/domain/threat_intelligence/` | Threat actor graph, pattern matching, attack paths |
| `examples/showcase/domain/microservices_reasoning/` | Service dependency graph, blast radius analysis |
