...
| Example | Focus |
|---------|-------|
| `examples/showcase/reasoning/multiway_reasoning/` | Multi-hypothesis reasoning via multiway expansion |
| `examples/showcase/domain/microservices_reasoning/` | Transitive dependency analysis in microservice graphs |
| `examples/showcase/core/centrality_and_ranking/` | Degree, betweenness, and PageRank centrality |
| `examples/showcase/core/paths_and_connectivity/` | Shortest paths and reachability in directed hypergraphs |
