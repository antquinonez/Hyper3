...
```bash
.venv/bin/python examples/showcase/centrality_and_ranking/centrality_and_pagerank.py
.venv/bin/python examples/showcase/centrality_and_ranking/centrality_comparison.py
.venv/bin/python examples/showcase/centrality_and_ranking/graph_statistics.py
```
