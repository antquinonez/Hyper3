...
| Example | Focus |
|---------|-------|
| `examples/showcase/bayesian_reasoning/` | Sequential Bayesian belief updating for root cause analysis |
| `examples/showcase/microservices_reasoning/` | Causal chain analysis in microservice architectures |
| `examples/showcase/multiway_reasoning/` | Multi-hypothesis parallel reasoning with state convergence |
| `examples/showcase/retrieval_and_feedback/` | Activation spreading and reinforcement learning |
