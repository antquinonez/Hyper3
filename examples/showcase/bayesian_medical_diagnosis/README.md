...
```bash
.venv/bin/python examples/showcase/bayesian_medical_diagnosis/bayesian_medical_diagnosis.py
```
...
| Example | Topic |
|---------|-------|
| `examples/showcase/quantum_diagnostics/` | Belief layer for hypothesis management |
| `examples/showcase/knowledge_reasoning/` | Rule-based inference and contradiction detection |
