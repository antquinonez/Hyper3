...
Run: .venv/bin/python examples/comparison/laminar/01_construction_and_queries.py
"""
...
def main() -> None:
    ...
    mem.add("alice", data={"role": "engineer", "team": "platform", "level": 5})
    mem.add("dave", data={"role": "manager", "team": "platform", "level": 7})
    mem.add("eve", data={"role": "designer", "team": "ux", "level": 4})
