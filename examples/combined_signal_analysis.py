...
def build_medical_kb(mem: CognitiveMemory) -> None:
    ...
    mem.relate("type 2 diabetes", "family history", label="risk_factor")
    ...
    mem.relate("hypertension", "high sodium intake", label="risk_factor")
    mem.relate("hypertension", "chronic stress", label="risk_factor")
    ...
    mem.relate("stroke", "smoking", label="risk_factor")

    mem.relate("obesity", "poor diet", label="risk_factor")
    ...
    mem.relate("depression", "family history", label="risk_factor")
    ...
    mem.relate("sleep apnea", "smoking", label="risk_factor")
    ...
    mem.relate("asthma", "smoking", label="risk_factor")
    mem.relate("asthma", "family history", label="risk_factor")

    mem.relate("statins", "high cholesterol", label="treats")
...
def main() -> None:
    ...
    print(f"Knowledge base: {mem.graph.node_count} nodes, {mem.graph.edge_count} edges\n")
