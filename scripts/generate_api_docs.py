...
PUBLIC_MODULES = [
    ...
    "hyper3.memory_base",
    "hyper3.memory_core",
    "hyper3.memory_reasoning",
    "hyper3.memory_belief",
    "hyper3.memory_bayesian",
    "hyper3.memory_analytics",
    "hyper3.memory_persistence",
    "hyper3.memory_provenance",
    "hyper3.memory_retrieval",
    "hyper3.memory_structural",
    "hyper3.memory_temporal",
    "hyper3.memory_cognitive",
    "hyper3.memory_monitoring",
    "hyper3.namespaces",
    "hyper3.belief",
    "hyper3.bayesian",
    "hyper3.multiway",
    "hyper3.multiway_causal",
    "hyper3.state_clustering",
    "hyper3.rules",
    "hyper3.rules_analogy",
    "hyper3.rules_causal_sequence",
    "hyper3.rules_complexity",
    "hyper3.rules_decomposition",
    "hyper3.rules_discovery",
    "hyper3.rules_inductive",
    "hyper3.rules_simultaneity",
    "hyper3.evolution",
    "hyper3.equivalence",
    "hyper3.community",
    "hyper3.traversal",
    "hyper3.traversal_selector",
    "hyper3.cache",
    "hyper3.event_log",
    "hyper3.exceptions",
    "hyper3.results",
    "hyper3.validation",
    "hyper3.backward_chain",
    "hyper3.hebbian",
    "hyper3.provenance",
    "hyper3.temporal",
    "hyper3.system_monitor",
    "hyper3.modality_fusion",
    "hyper3.multi_perspective",
    "hyper3.structural_anomaly",
    "hyper3.structural_impact",
    "hyper3.structural_match",
    "hyper3.structural_prefetch",
    "hyper3.rule_analytics",
    "hyper3.interference_reasoning",
    "hyper3.boundary_reasoning",
    "hyper3.transcendental",
    "hyper3.collapse_trigger",
    "hyper3.invariant_detector",
    "hyper3.uncertainty",
    "hyper3.feedback",
    "hyper3.abstraction",
    "hyper3.adaptive_slice",
    "hyper3.auto_abstraction",
    "hyper3.basis_selector",
    "hyper3.belief_revision",
    "hyper3.capabilities",
    "hyper3.causal_learner",
    "hyper3.concept_set",
    "hyper3.consistency",
    "hyper3.constraints",
    "hyper3.collapse_trigger",
    "hyper3.context_compression",
    "hyper3.efficiency",
    "hyper3.embedding",
    "hyper3.embedding_graph",
    "hyper3.enrichment",
    "hyper3.entanglement",
    "hyper3.evolution_feedback",
    "hyper3.frame_cache",
    "hyper3.frame_transform",
    "hyper3.generators",
    "hyper3.graph_diff",
    "hyper3.layered_graph",
    "hyper3.overlay",
    "hyper3.persistence",
    "hyper3.persistence_sqlite",
    "hyper3.recency",
    "hyper3.retrieval_activation",
    "hyper3.retrieval_engine",
    "hyper3.search_engine",
    "hyper3.search_facets",
    "hyper3.search_index",
    "hyper3.search_planner",
    "hyper3.search_query",
    "hyper3.search_scoring",
    "hyper3.snapshot",
    "hyper3.types_api",
    "hyper3.visualization",
    "hyper3.kernel_base",
    "hyper3.kernel_centrality",
    "hyper3.kernel_clustering",
    "hyper3.kernel_coloring",
    "hyper3.kernel_components",
    "hyper3.kernel_cycles",
    "hyper3.kernel_dynamics",
    "hyper3.kernel_link_prediction",
    "hyper3.kernel_paths",
    "hyper3.kernel_pattern",
    "hyper3.kernel_query",
    "hyper3.kernel_similarity",
    "hyper3.kernel_spectral",
    "hyper3.kernel_structural",
    "hyper3.kernel_transforms",
]
...
def generate_module(module_name: str) -> str | None:
    ...
    lines: list[str] = []
    short_name = module_name.removeprefix("hyper3.")
    ...
    for name in dir(mod):
        ...
        if defining and defining != module_name and not defining.startswith("hyper3." + module_name.removeprefix("hyper3.")):
            continue
...
def build_index(entries: list[tuple[str, str]]):
    ...
    class_entries: dict[str, tuple[str, str]] = {}
