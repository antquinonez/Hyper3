...
.venv/bin/python scripts/generate_sphinx_docs.py                      # Generate .rst + build html/text/json
```
...
| HTML site | Humans (search, navigation, source links) | `docs/sphinx/build/html/` |
| Plaintext per page | AI context windows (token-efficient) | `docs/sphinx/build/text/` |
| Structured JSON per page | Programmatic traversal (toctree, sections) | `docs/sphinx/build/json/` |
