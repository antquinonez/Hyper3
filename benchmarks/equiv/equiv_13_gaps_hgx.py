...
def run() -> EquivRunner:
    ...
    t.gap("sub_hypergraph_centrality", "subhypergraph_centrality(HG) -- Estrada & Rodriguez-Velazquez 2005")
    ...
    t.gap("random_walk", "random_walk(HG, s, time) -- single-node walk (Carletti 2017)")
    t.gap("random_walk_density", "random_walk_density(HG, rho, time) -- density-vector walk")
    t.gap("transition_matrix", "transition_matrix(HG) -- random walk transition matrix")
    t.gap("stationary_state", "RW_stationary_state(HG) -- stationary distribution")
    ...
    t.gap("random_shuffle", "random_shuffle(hg, p=1.0) -- randomize fraction of edges")
    t.gap("multiorder_laplacian", "compute_multiorder_laplacian(hg, sigmas) -- weighted sum across orders")
    t.gap("incidence_matrix_by_order", "incidence_matrix_by_order(hg, order=2)")
    ...
    t.gap("core_periphery", "core_periphery(hg) -- core-periphery scores")
    t.gap("hy_mmsbm", "HyMMSBM.fit() -- Mixed-Membership Stochastic Block Model")
    t.gap("hysc", "HySC.fit() -- Hypergraph Spectral Clustering model")
    ...
    t.gap("hash_hypergraph", "hash_hypergraph(hg) -- SHA-256 deterministic hash")
    t.gap("degree_correlation", "degree_correlation(hg) -- Pearson correlation across sizes")
    t.gap("clique_projection", "clique_projection(h) -- expand hyperedges into cliques")
    t.gap("simplicial_complex_construction", "simplicial_complex(h) -- fill in all subsets of edges")
