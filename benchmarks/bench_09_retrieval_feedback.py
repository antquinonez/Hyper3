"""
Bench 9: Retrieval Quality with Feedback Learning
==================================================

Tests retrieval quality across strategies (activation only, similarity only,
RRF combined) on an AI/ML concept graph, then measures improvement from
learning-to-rank feedback training.

Metrics: P@5, R@5, MRR, pre/post comparison

Run:
    .venv/bin/python benchmarks/bench_09_retrieval_feedback.py
"""
